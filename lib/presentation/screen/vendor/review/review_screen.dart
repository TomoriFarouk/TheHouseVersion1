    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
            ProgressBar(color2: ColorManager.goldColor,color3:  ColorManager.goldColor,color4:   ColorManager.goldColor,),
             ...
             Column(
               children: [
                 ...
                 SizedBox(
                   height:72.h,
                   width:239.w,
                   child: BodyText(text: 'We have recieved your application and will review it shortly.We will get back to you via email and let you know the next steps', 
                size: 14.sp,),
                 )
               ],
             ),
