...
class FinanceScreen extends StatelessWidget with PreferredSizeWidget {
  static const String routeName = '/cart';

  static Route route() {
    return MaterialPageRoute(settings: RouteSettings(name: routeName), builder: (_) => FinanceScreen());
  }
